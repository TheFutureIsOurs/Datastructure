...
<div class="login_box" id="login_bg">
	...
	<!-- 
	 ...
	 -->
   	 <form name="myform" method="post" action="<?php echo Yii::app()->request->baseUrl; ?>?r=auth/login">
   	 <input type="submit" class="login_tj_btn" value="" name="dosubmit">
   	 <label>用户名：</label><input type="text" value="" class="ipt" name="username">
   	 <label>密码：</label><input type="password" value="" class="ipt" name="password">
   	 <label>验证码：</label><input type="text" onfocus="document.getElementById('yzm').style.display='block'" class="ipt ipt_reg" name="code">
